...
- 2022.11.07~11.11<br/>
    사용자 게시물 상세 UI 수정<br/>
    사용자 게시판 게시물 좋아요 api 좋아요 및 UI 작업<br/>
    CommonData에 게시판 관련 데이터를 싱글톤 객체로 선언

- 2022.10.31~11.03<br/>
    사용자 게시판 게시물 댓글 작성 api 연동 및 UI 작업<br/>
    게시물 리스트 댓글 수 백엔드 수정 및 UI 작업

- 2022.10.16~10.28<br/>
    게시물 리스트 api 호출 위치 변경<br/>
    게시물 상세 ui 수정<br/>
    게시물 리스트 ui 수정<br/>
    게시물 상세 댓글 ui 추가<br/>
    navigateup 이슈 임시 조치
...
- 2022.10.15~10.18<br/>
    게시물 리스트 onResume에 추가<br/>
    게시물 상세 ui 수정<br/>
    게시글 리스트 앱 바에 게시판 이름 추가<br/> 
    서버쪽 사용자 게시물 조회수 업데이트 쿼리 수정

- 2022.10.08~10.14<br/>
    사용자 게시판 게시물 상세 api 연동 작업<br/>
    사용자 게시판 게시물 목록 api 연동 작업<br/>
    사용자 게시판 게시물 글쓰기 api 연동 작업<br/>
    코드 정리 및 변수 명 변경

- 2022.09.26~10.07<br/>
    모닥불 상세화면 data class 정리<br/>
    기존에 서버에서 받던 JsonArray를 ArrayList로 파싱하는 작업(기존 코드 수정)<br/>
    모닥불 글 등록 UI 작업

- 2022.09.18~09.25<br/>
    서버 이용 기간 만료로 로컬 서버 새로 구축<br/>
    리스트 내용 없을 때 표시<br/>
    모닥불 상세화면 UI 작업 및 API 연동
...
- 2022.08.25~09.01<br/>
    ...
    홈 화면 로직 전체적으로 수정(코루틴 적용, 상세화면 이동할 때 Fragment에서 Activity 변경)<br/>
